 ...
 * Plugin URI: https://wp-signals.com/
 * Description: WP Signals tracks logged-in user activity so you can monitor every change made on your WordPress site in beautifully organized detail. All activity is organized by context, action and IP address for easy filtering. Developers can extend Signals with custom connectors to log any kind of action.
 * Version: 2.0.5
 * Author: Jared Martin
 * Author URI: https://wp-signals.com/
 * License: GPLv2+
 * Text Domain: signals
...
/**
 * Copyright (c) 2015 WP Signals Pty Ltd (https://wp-signals.com/)
 *
...
class WP_Stream {
	...
	public static function is_connected() {
		// error_log("self::api->api_key".self::$api->api_key);
		// error_log("self::api->site_uuid".self::$api->site_uuid);
