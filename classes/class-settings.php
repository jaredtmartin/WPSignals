		...
		$fields = array(
			'general' => array(
				...
				'fields' => array(
					// array(
					// 	'name'        => 'api_key',
					// 	'title'       => esc_html__( 'Site Key', 'stream' ),
					// 	'type'        => 'text',
					// 	'desc'        => esc_html__( 'What is your Key?', 'stream' ),
					// ),
					array(
						'name'				=> 'connect_button',
						'title'				=> 'Connect',
						'type'        => 'connect_button',
						'desc'        => esc_html__( 'Click here to connect to your WP Signals account.', 'stream' ),
					),
					array(
						'name'        => 'role_access',
		...
		switch ( $type ) {
			...
			case 'connect_button':
				if(get_option('site_uuid')){
					$output = '<a href="'.$this->get_disconnect_url().'" class="button">Disconnect</a>';
				} else {
					$output = '<a href="'.$this->get_connect_url().'" class="button">Connect</a>';
				}
				break;
			case 'rule_list' :
